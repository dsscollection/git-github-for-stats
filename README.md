Git and GitHub for statistical practice and teaching
================
Jenny Bryan
2017-04-24

*Alternative title: Excuse me, do you have a moment to talk about Git and GitHub?*
...
Benefits of using hosted version control as your *modus operandi*:

-   Doing your work becomes tightly integrated with organizing, recording, and disseminating it.
...
-   By using common mechanics across work modes, you achieve basic competence quickly and avoid the demoralizing forget-relearn cycle.
...
Many people who don't use Git are unwittingly creating a poor man's version of it. They create long chains of copies of an important file, decorating the name with initials, dates and other descriptors. The Git way is to track the evolution of that file, through a series of commits, each equipped with an explanatory message and a nickname. Especially important versions are given a human-readable tag, to signal a meaningful milestone. Yes, there is some pain in adopting the formalism of Git, but it is worth it.
