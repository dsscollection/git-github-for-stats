...
\begin{figure}
\includegraphics[width=1\linewidth]{commit-diff-sha-tag} \caption{\label{fig:commit-diff-sha-tag}Partial commit history for our iris example.}\label{fig:commit-diff-sha-tag}
\end{figure}
