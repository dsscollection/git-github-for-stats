...
goof up the Git infrastructure for a project. Note that your files can be intact
...
issues and the project files or file changes, you have extraordinary power to 
...
projects. Some general recommendations for agony reduction:
