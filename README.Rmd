...
The files at the far right are clearly derived and are often described as __targets__. These files are programmatically generated from source files (and possibly other inputs). These files are the product and they have external value, often for communicating ideas and results.
