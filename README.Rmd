...
Why would a statistician use a version control system, such as [Git](http://git-scm.com) [@git]? And what is the point of hosting your work online, e.g., on [GitHub](https://github.com) [@github]? Could the gains possibly justify the inevitable pain?
